...
function index()
	...
	--entry({"admin", "awsuimodule", "aws_tab_logs_startup"},    call("action_awsiotlog_startup"), "Service Startup Log", 4)
        entry({"admin", "awsuimodule", "aws_tab_cbi_sttng"},     cbi("awsiot_cbi/awsiot-srvice-settings"), "Service Settings", 4)
        entry({"admin", "awsuimodule", "aws_tab_cbi_evnt"},     cbi("awsiot_cbi/awsiot-event-settings"), "Event Settings", 5)
